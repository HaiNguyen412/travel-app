...
<body>
    <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:500px;background:#4cbd9b" align="center" border="0">
        <tbody>
            <tr>
                <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:28px 15px">
                    <div class="m_-1514011597316807246mj-column-per-100" style="vertical-align:top;display:inline-block;
                            direction:ltr;font-size:13px;text-align:left;width:500px">
                            <table role="presentation" cellpadding="0" cellspacing="0" width="500px" border="0">
                                <tbody>
                                    <tr>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="500px" style="border-collapse:collapse;width:500px;
        ...
        <tr>
            ...
            <td style="font-weight:400;border-top:solid 1px #eee;border-left:solid 1px #eee;
                ...
                <p style="margin-top:8px;margin-bottom:6px">
                    <span style="white-space:nowrap">Status: {{ $data['status'] }}</span>
                    <span style="padding-left:1em;padding-right:1em;color:#666">|</span>
